...
import eu.janinko.botninko.listeners.ConnectionListenerLogger;
import eu.janinko.botninko.listeners.XmppConnectionListener;
...
public class Connection {
	...
	private HashMap<String, RoomImpl> rooms = new HashMap<>();
	 ...
	 */
	public Map<String,RoomImpl> getRooms() {
		return rooms;
	}
	 ...
	 * @return This instance of XmppConnection.
	 */
	public RoomImpl addRoom(String room, String nick) {
